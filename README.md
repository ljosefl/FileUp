...
1. Создайте публичный репозиторий и публикуйте [релизы](https://docs.github.com/repositories/releasing-projects-on-github/managing-releases-in-a-repository) с тегом вида `v0.9.1` (или `0.9.1`).  
